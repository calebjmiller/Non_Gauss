function [post_samples, Y, theta, phi, k_theta, k_phi, Npix, ind] = sd_o_thin_sim(R, seed)
% simulation study
...
for rep = 1:R
    ...
    % for R code
    % save('sd_theta_o_995_thin_14.mat','theta');
    % pause
    ...
    load('sd_o_995_thin_14_deriv_B_spline.mat')
    b_mat_deriv = bS;
